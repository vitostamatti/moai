...
interface IndexBinaryOpNodeFormFieldProps<T extends FieldValues> {
  name: FieldPath<T>;
  control: Control<T>;
  title?: string;
}

export const IndexBinaryOpNodeFormField = <T extends FieldValues>({
  name,
  control,
  title,
}: IndexBinaryOpNodeFormFieldProps<T>) => {
